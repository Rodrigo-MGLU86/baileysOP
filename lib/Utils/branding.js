...
const BRAND = Object.freeze({
  name: "Neelify",
  headerClaim: "Hier ist die beste Version von Neelify",
  footerClaim: "Die beste Neelify Generation fuer WhatsApp Web",
  footerTagline: "Built for the best WhatsApp Web experience"
});
...
const getQrBranding = async () => {
  ...
  const headerLines = [
    ...
    color(`Neelify Version: ${versions.baileysVersion}`, ANSI.cyan),
  ...
  if (versions.libsignalVersion) {
    headerLines.push(color(`Signal-Core: @neelify/libsignal v${versions.libsignalVersion}`, ANSI.cyan));
  }
